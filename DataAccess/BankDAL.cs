...
namespace WIS_DataAccess
{
    public class BankDAL
    {
        ...
        public string AddBank(BankBO objBank)
        {
            ...
            cmd.Parameters.AddWithValue("bankName_", objBank.BankName);
           
            cmd.Parameters.AddWithValue("createdby_", objBank.CreatedBy);
        ...
        public string UpdateBank(BankBO objBank)
        {
            ...
            cmd.Parameters.AddWithValue("bankID_", Convert.ToSingle(objBank.BankID));
            cmd.Parameters.AddWithValue("bankName_", objBank.BankName);
           
            cmd.Parameters.AddWithValue("updatedby_", objBank.UpdatedBy);
            /* cmdd.Parameters.AddWithValue("errorMessage_", SqlDbType.NVarChar).Direction = ParameterDirection.Output;*/ SqlParameter outputValue = cmd.Parameters.Add("errorMessage_", SqlDbType.VarChar); outputValue.Size=200; outputValue.Direction = ParameterDirection.Output;
            cmd.ExecuteNonQuery();
