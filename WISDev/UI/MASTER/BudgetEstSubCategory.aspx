<%@ Page Title="" Language="C#" MasterPageFile="~/SitePopup.Master" AutoEventWireup="true" CodeBehind="BudgetEstSubCategory.aspx.cs" Inherits="WIS.SubCategory" %>
<%@ MasterType VirtualPath="~/SitePopup.Master" %>
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="server">
</asp:Content>
<%--/**
 * 
 * @version		 0.1 Budget Est Sub Category Master UI screen   
 * @package		 WIS
    ...
    <div style="width: 100%">
            ...
            <table border="0" align="center" width="55%">
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <asp:RequiredFieldValidator ID="reqsubcategry" runat="server" ErrorMessage="Enter Account Code"
        ...
        <asp:GridView ID="grdSubcategory" runat="server" AllowPaging="True" OnPageIndexChanging="ChangePage"
            ...
            <Columns>
                ...
                <asp:BoundField DataField="ACCOUNTCODE" HeaderText="Account Code" HeaderStyle-HorizontalAlign="Center" HeaderStyle-Width="15%" ItemStyle-HorizontalAlign="Center" />
