...
namespace WIS
{
    ...
    {   
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                if (CheckAuthorization.HasUpdatePrivilege(UtilBO.PrivilegeCode.PRIV_BUDGET_EST_CATEGORY) == false)
                {
                    ...
                    grdSubcategory.Columns[grdSubcategory.Columns.Count - 1].Visible = false;
                    grdSubcategory.Columns[grdSubcategory.Columns.Count - 2].Visible = false;
                    grdSubcategory.Columns[grdSubcategory.Columns.Count - 3].Visible = false;
                }
            }
        }
        /// <summary>
        ...
        private void GetSubCategoryDetails()
        {
            ...
            txtAccountCode.Text = SubCategoryBOobj.ACCOUNTCODE;
        }
        /// <summary>
