<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" UICulture="en" Culture="en-US"
    CodeBehind="MyTasks_Approval.aspx.cs" Inherits="WIS.MyTasks_Approval" %>
        ...
        function OpenSourcePage(ProjectID, HHID, userID, ProjectCode, Mode, PageCode, ApprovalLevel) {
            ...
            if (PageCode == 'HH') {
                ...
                open('../COMPENSATION/PackagePaymentRequest.aspx?ProjectID=' + ProjectID + '&HHID=' + HHID + '&UserID=' + userID + '&ProjectCode=' + ProjectCode + '&Mode=' + Mode, 'ViewPagedetailsRead', 'width=960px,height=650px,resizable=1,scrollbars=1,top=' + top + ', left=' + left);
                        ...
                        PageCode == 'DEL3B' || PageCode == 'PERID' || PageCode == 'MNDOC' || PageCode == 'DCRP' || PageCode == 'OPTDS' || PageCode == 'CRP' || PageCode == 'FIXT' || PageCode == 'ATTR' || PageCode == 'RES' || PageCode == 'BLDG' || PageCode == 'CPREV-PAYRQ') {
                open('../COMPENSATION/CompensationPackages.aspx?ProjectID=' + ProjectID + '&HHID=' + HHID + '&UserID=' + userID + '&ProjectCode=' + ProjectCode + '&Mode=' + Mode + '&ApprovalLevel=' + ApprovalLevel + '&PageCode=' + PageCode, 'ViewPagedetailsRead', 'width=960px,height=650px,resizable=1,scrollbars=1,top=' + top + ', left=' + left);
            }
