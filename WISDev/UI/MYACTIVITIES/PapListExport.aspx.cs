...
namespace WIS
{
    public partial class PapListExport : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                BindDistricts();
                BindGrid(true);
                if (CheckAuthorization.HasUpdatePrivilege(UtilBO.PrivilegeCode.PRIV_PAP_LIST_EXPORT) == false)
                {
        ...
        /// <summary>
        /// To search pap data and bind to grid
        /// </summary>
        /// <param name="sender"></param>
        /// <param name="e"></param>
        ...
        /// <summary>
        /// To bind counties subcounties village and parish dropdownlist
        /// </summary>
        /// <param name="sender"></param>
        /// <param name="e"></param>
        ...
        /// <summary>
        /// To bind  subcounties village and parish dropdownlist
        /// </summary>
        /// <param name="sender"></param>
        /// <param name="e"></param>
        ...
        /// <summary>
        /// To bind   village and parish dropdownlist
        /// </summary>
        /// <param name="sender"></param>
        /// <param name="e"></param>
        ...
        /// <summary>
        /// To export all details of grid  to excel
        /// </summary>
        /// <param name="sender"></param>
        /// <param name="e"></param>
        ...
        /// <summary>
        /// to assign particular column value of grid to particular column of excel
        /// </summary>
        /// <returns></returns>
        ...
        /// <summary>
        /// To bind counties values from database to counties dropdownlist based on districtID
        /// </summary>
        ...
        /// <summary>
        /// To bind district values from database to district dropdownlist
        /// </summary>
        ...
        /// <summary>
        /// To bind subcounty values from database to subcounty dropdownlist based on countyID
        /// </summary>
        ...
        /// <summary>
        /// To bind village values from database to village dropdownlist based on subcounty
        /// </summary>
        ...
        /// <summary>
        /// To bind Parish values from database to parish dropdownlist on subcounty
        /// </summary>
        /// <param name="subCounty"></param>
        ...
        protected void BindGrid(bool showRecentRecords)
        {
            ...
            grdPAPs.DataSource = objPAPLogic.SearchPAPForPapExport(showRecentRecords,
