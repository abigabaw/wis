<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" UICulture="en" Culture="en-US"
    CodeBehind="DisputeRsolutionTracking.aspx.cs" Inherits="WIS.DisputeRsolutionTracking" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
        ...
        <table width="100%" align="center" border="0">
            ...
            <tr>
                ...
                <ajaxToolkit:MaskedEditExtender ID="mskPlotReference" runat="server" MessageValidatorTip="true"
                    TargetControlID="txtPlotReference" clearmaskonlostfocus="false">
    ...
    <div>
        <CR:CrystalReportViewer ID="CrystalReportViewer1" runat="server" AutoDataBind="True"
            ...
            GroupTreeImagesFolderUrl="" Height="1158px" ToolbarImagesFolderUrl="" ToolPanelWidth="200px" />
    </div>
</asp:Content>
