...
namespace WIS
{
    public partial class DisputeRsolutionTracking : System.Web.UI.Page
    {
        /// <summary>
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                if (Session["PROJECT_CODE"] != null)
                    Master.PageHeader = Session["PROJECT_CODE"].ToString() + " - Dispute Resolution Tracking Report";
                else
                    Master.PageHeader = "Dispute Resolution Tracking Report";
        ...
        private void LoadReport()
        {
            ...
            CrystalReportViewer1.ReportSource = ResolveUrl("~/REPORTS/DisputeResolutionTracking.rpt");
            ...
            if (txtPlotreference.Text != string.Empty)
            {
                paramPlotReferenceVal.Value = txtPlotreference.Text;
            }
            else
            {
                paramPlotReferenceVal.Value = string.Empty;
            }
