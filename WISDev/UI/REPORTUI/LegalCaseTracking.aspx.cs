...
namespace WIS
{
    public partial class LegalCaseTracking : System.Web.UI.Page
    {
        /// <summary>
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                if (Session["PROJECT_CODE"] != null)
                    Master.PageHeader = Session["PROJECT_CODE"].ToString() + " - Legal Case Tracking Report";
                else
                    Master.PageHeader = "Legal Case Tracking Report";
                BindDistricts();
                BindProject();
        ...
        private void LoadReport()
        {
            ...
            CrystalReportViewer1.ReportSource = ResolveUrl("~/REPORTS/Legal Case Tracking.rpt");
