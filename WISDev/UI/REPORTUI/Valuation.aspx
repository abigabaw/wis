<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" UICulture="en" Culture="en-US"
    CodeBehind="Valuation.aspx.cs" Inherits="WIS.Valuation" %>
    ...
    <fieldset class="icePnlinner">
        ...
        <table width="100%" align="center" border="0">
            ...
            <tr>
                ...
                <td align="left">
                    <asp:DropDownList ID="ddlDistrict" ClientIDMode="Static" CssClass="iceTextBox" AppendDataBoundItems="true"
                ...
                <td align="left">
                    <asp:UpdatePanel ID="UpdatePanel1" UpdateMode="Conditional" runat="server">
                        <ContentTemplate>
                            <asp:DropDownList ID="ddlCounty" ClientIDMode="Static" CssClass="iceTextBox" AutoPostBack="true"
                                Width="250px" runat="server" OnSelectedIndexChanged="ddlCounty_SelectedIndexChanged">
                                <asp:ListItem Value="0">--Select--</asp:ListItem>
                            </asp:DropDownList>
                        </ContentTemplate>
                        <Triggers>
            ...
            <tr>
                ...
                <td align="left">
                    <asp:UpdatePanel ID="uplSubCounty" UpdateMode="Conditional" runat="server">
                        <ContentTemplate>
                            <asp:DropDownList ID="ddlSubCounty" ClientIDMode="Static" CssClass="iceTextBox" AutoPostBack="true"
                                Width="250px" runat="server" OnSelectedIndexChanged="ddlSubCounty_SelectedIndexChanged">
                                <asp:ListItem Value="0">--Select--</asp:ListItem>
                            </asp:DropDownList>
                        </ContentTemplate>
                        <Triggers>
                ...
                <td align="left">
                    <asp:UpdatePanel ID="uplParish" UpdateMode="Conditional" runat="server">
                        <ContentTemplate>
                            <asp:DropDownList ID="ddlParish" ClientIDMode="Static" CssClass="iceTextBox" Width="250px"
                                runat="server">
                                <asp:ListItem Value="0">--Select--</asp:ListItem>
                            </asp:DropDownList>
                        </ContentTemplate>
            ...
            <tr>
                ...
                <td align="left">
                    <asp:UpdatePanel ID="uplVillage" UpdateMode="Conditional" runat="server">
                        <ContentTemplate>
                            <asp:DropDownList ID="ddlVillage" ClientIDMode="Static" CssClass="iceTextBox" Width="250px"
                                runat="server">
                                <asp:ListItem Value="0">--Select--</asp:ListItem>
                            </asp:DropDownList>
                        </ContentTemplate>
                ...
                <td align="left">
                    <asp:TextBox ID="txtPAPName" ClientIDMode="Static" runat="server" MaxLength="100"
                        CssClass="iceTextBox" Width="250px" />&nbsp;<asp:ImageButton ID="imgSearch"  runat="server" ValidationGroup="vgSearch" ImageAlign="Bottom" ToolTip="Click here to change PAP"
