...
namespace WIS
{
    public partial class LivelihoodSupport : System.Web.UI.Page
    {
        /// <summary>
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                if (Session["PROJECT_CODE"] != null)
                    Master.PageHeader = Session["PROJECT_CODE"].ToString() + " - Livelihood Support Report";
                else
                    Master.PageHeader = "Livelihood Support Report";
        ...
        private void LoadReport()
        {
            ...
            CrystalReportViewer1.ReportSource = ResolveUrl("~/REPORTS/LiveliHoodSupportRPT.rpt");
