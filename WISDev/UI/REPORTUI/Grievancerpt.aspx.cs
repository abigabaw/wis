...
namespace WIS
{
    public partial class Grievancerpt : System.Web.UI.Page
    {
        /// <summary>
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                if (Session["PROJECT_CODE"] != null)
                    Master.PageHeader = Session["PROJECT_CODE"].ToString() + " - Grievance Report";
                else
                    Master.PageHeader = "Grievance Report";
