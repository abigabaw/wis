...
namespace WIS
{
    public partial class MonitoringResultEvaluation : System.Web.UI.Page
    {
        /// <summary>
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                if (Session["PROJECT_CODE"] != null)
                    Master.PageHeader = Session["PROJECT_CODE"].ToString() + " - Monitoring Result and Evaluation";
                else
                    Master.PageHeader = "Monitoring Result and Evaluation";
