...
namespace WIS
{
    public partial class FundProgress : System.Web.UI.Page
    {
        /// <summary>
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                Master.PageHeader =  "Fund Request Progress";
                BindDistricts();
                RadioButtonRIP.Checked = true;
                BindProject();
        ...
        protected void btnClear_Click(object sender, EventArgs e)
        {
            ...
            //if (RadioButtonRIP.Checked == true)
            //{
            //    RadioButtonRIP.Checked = false;
            //}
            //else if (RadioButtonRF.Checked == true)
            //{
            //    RadioButtonRF.Checked = false;
            //}
        ...
        //    else if (RadioButtonRF.Checked == true)
        //    {
        //         myRpt.Load(RPT_SOURCE + "FundRequest.rpt");
        //    }
        ...
        //    ParameterDiscreteValue paramHHIDeVal = new ParameterDiscreteValue();
        ...
        //    paramHHIDeVal.Value = Convert.ToInt32(Session["HH_ID"]);
        ...
        //    paramHHID.CurrentValues.Add(paramHHIDeVal);
