...
namespace WIS
{
    public partial class CompensationBeneficiary : System.Web.UI.Page
    {
        /// <summary>
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                if (Session["PROJECT_CODE"] != null)
                    Master.PageHeader = Session["PROJECT_CODE"].ToString() + " - Compensation Beneficiary Report";
                else
                    Master.PageHeader = "Compensation Beneficiary Report";
       ...
       /// </summary>
        private void LoadReport()
        {
            ...
            CrystalReportViewer1.ReportSource = ResolveUrl("~/Reports/");
