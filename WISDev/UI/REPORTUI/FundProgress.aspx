<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" UICulture="en" Culture="en-US"
    CodeBehind="FundProgress.aspx.cs" Inherits="WIS.FundProgress" %>
        ...
        <label class="iceLable">
            ...
            <tr>
             <td align="left" class="style1">
                ...
                <td>
                <asp:RadioButton ID="RadioButtonRIP" runat="server" GroupName = "Radiobtn" ClientIDMode="Static" Text = "In Progress" />
                 </td>
                
                 <td>
                <asp:RadioButton ID="RadioButtonRF" runat="server" GroupName = "Radiobtn" ClientIDMode="Static" Text = "Finished"/>
                 </td>
            </tr>
              <tr>
             ...
             <script language="javascript">
                 function OpenReport() 
                 {
                     ...
                     var RadioButtonRIP = document.getElementById('<%=RadioButtonRIP.ClientID%>');
