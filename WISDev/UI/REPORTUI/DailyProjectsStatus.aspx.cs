...
namespace WIS
{
    public partial class DailyProjectsStatus : System.Web.UI.Page
    {
        /// <summary>
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                if (Session["PROJECT_CODE"] != null)
                    Master.PageHeader = Session["PROJECT_CODE"].ToString() + " - Daily Project Status Report";
                else
                    Master.PageHeader = "Daily Project Status Report";
               // Master.PageHeader = "Daily Project Status Report";
                BindDistricts();
                BindProject();
            }
            //hdnProjectID.Value = Session["PROJECT_ID"].ToString();
        }
        /// <summary>
        ...
        //    CrystalReportViewer1.ReportSource = ResolveUrl("~/REPORTS/DailyProjectStatus.rpt");
