<%@ Page Title="" Language="C#" MasterPageFile="~/SitePopup.Master" AutoEventWireup="true"
    CodeBehind="ConversationLog.aspx.cs" Inherits="WIS.ConversationLog" %>
           ...
           <%--  <tr>
                ...
                <tr>
                    ...
                    <td style="background-color:White">
                            <asp:Label ID="LblActionTakenby" runat="server" Text= '<%#Eval("ApproverName")%>'></asp:Label>
                    </td>
                     <td align="center" style="width:70;background-color:White;vertical-align:top;">
                            <asp:Label ID="LblActionTakenDate" runat="server" Text= '<%#Eval("ApprovalDateTime")%>'></asp:Label>
                    </td>
                    <td style="background-color:White">
